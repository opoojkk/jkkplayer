...
Java_com_opoojkk_jkkplayer_FFmpegNative_initFFmpeg(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_opoojkk_jkkplayer_FFmpegNative_readFile(JNIEnv *env, jobject thiz, jstring file_name) {
    ...
    for (unsigned int i = 0; i < pFormatContext->nb_streams; i++) {
        ...
        logi(tag, "Stream %u: Codec ID: %d, Type: %d, Bitrate: %lld\n",
